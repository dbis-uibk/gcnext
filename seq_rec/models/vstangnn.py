...
class VSTANGNN(SequentialRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.lambda_ipw = config['lambda_ipw']
        self.lambda_idf = config['lambda_idf']
    ...
    def cosine_item_emb(self, current_items, neighbor_items, pos_map):
        ...
        emb_distances = np.array(
            [[self.current_item_emb_distances[c][n] for n in neighbor_items] for c in current_items])
    ...
    def score_items(self, neighbors, current_session):
        ...
        for session in neighbors:
            ...
            for item in n_items:
                ...
                if self.lambda_idf is not None and item in self.idf:
