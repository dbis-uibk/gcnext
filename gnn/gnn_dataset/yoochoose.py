...
item_names = ['item_id:token', 'category_id:token']
...
class YoochooseDatasetPyG(BaseSessionGNNDatasetPyG):
    def __init__(self, dataset_name='yoochoose', pre_dataset_path=None, save_dir=None, transform=None, pre_transform=None,
...
if __name__ == '__main__':
    dataset = YoochooseDatasetPyG(dataset_name='yoochoose-64', pre_dataset_path='../../data/yoochoose-64/', use_chached=False)
    graph = dataset[0]
