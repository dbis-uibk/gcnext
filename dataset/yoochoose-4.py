...
class YooChooseDataset(BaseDataset):
    def __init__(self, input_path, output_path, min_item_support=5, min_session_length=2, max_session_length=50,
        ...
        super(YooChooseDataset, self).__init__(input_path, output_path, dataset_name='yoochoose-4')
        self.dataset_name = 'yoochoose-4'
        ...
        self.prepare_dataset(df_inter, size=(25/100))


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset', type=str, default='yoochoose-4')
    parser.add_argument('--input_path', type=str, default="../data/yoochoose-4")
    parser.add_argument('--output_path', type=str, default="../data/yoochoose-4")
